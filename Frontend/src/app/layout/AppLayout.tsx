...
const SECCIONES: { titulo: string; items: ItemNav[] }[] = [
  {
    titulo: 'General',
    items: [{ ruta: '/app', etiqueta: 'Panel', Icono: LayoutDashboard, exacto: true }],
  },
  {
    titulo: 'Clínica',
    items: [
      { ruta: '/app/citas', etiqueta: 'Agenda de citas', Icono: CalendarDays },
      { ruta: '/app/clientes', etiqueta: 'Clientes', Icono: Users },
      { ruta: '/app/mascotas', etiqueta: 'Mascotas', Icono: Dog },
      { ruta: '/app/historiales', etiqueta: 'Historias clínicas', Icono: Stethoscope },
      { ruta: '/app/vacunacion', etiqueta: 'Vacunación', Icono: Syringe },
      { ruta: '/app/recetas', etiqueta: 'Recetas', Icono: ClipboardList },
    ],
  },
  {
    titulo: 'Comercial',
    items: [
      { ruta: '/app/productos', etiqueta: 'Productos', Icono: Package },
      { ruta: '/app/inventario', etiqueta: 'Inventario', Icono: Boxes },
      { ruta: '/app/facturas', etiqueta: 'Facturación', Icono: Receipt },
    ],
  },
  {
    titulo: 'Configuración',
    items: [
      { ruta: '/app/catalogos', etiqueta: 'Catálogos', Icono: Tags },
      { ruta: '/app/usuarios', etiqueta: 'Usuarios', Icono: UserSquare },
      { ruta: '/app/veterinarios', etiqueta: 'Veterinarios', Icono: Stethoscope },
      { ruta: '/app/accesos', etiqueta: 'Roles y permisos', Icono: ShieldCheck },
      { ruta: '/app/empresas', etiqueta: 'Empresas', Icono: Building2 },
    ],
  },
]
      ...
      <aside className="hidden w-64 shrink-0 flex-col bg-brand-950 lg:flex">
        <div className="flex items-center gap-3 border-b border-brand-900 px-5 py-5">
          ...
          <div className="min-w-0">
            ...
            <p className="truncate text-xs text-brand-400">{nombreEmpresa ?? 'Sin empresa'}</p>
          </div>
        </div>
